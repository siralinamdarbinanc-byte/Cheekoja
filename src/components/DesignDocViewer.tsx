  ...
  const sections = [
    {
      ...
      content: `
### فلسفه اصلی "چیکجا"
چیکجا یک موتور جستجوی محلی زنده، ساده و فوق‌العاده سریع برای پیدا کردن کالاها، خدمات و کسب‌وکارهای ایران است.
...
- کاربر نمی‌تواند ۲ روز منتظر پست آنلاین بماند؛ باید همین الان مغازه باز محلی را پیدا کند.
    ...
    },
    {
      ...
      icon: ShieldCheck,
      content: `
| ویژگی | Google Maps | بلد / نشان | دیوار / شیپور | **چیکجا (CheKoja)** |
| :--- | :--- | :--- | :--- | :--- |
...
3. **کامل بودن اطلاعات**: عکس، شماره همراه، و توضیحات شانس دیده شدن را افزایش می‌دهد.
    ...
    },
    {
      ...
      icon: Stack,
      content: `
- **هدر**: لوگوی چیکجا + دکمه موقعیت من + تغییر تم + پنل کسب‌وکار.
      ...
      >
        ...
        <div className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between border-b border-slate-800 shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-extrabold">سند جامع طراحی و معماری محصول (چیکجا)</h2>
